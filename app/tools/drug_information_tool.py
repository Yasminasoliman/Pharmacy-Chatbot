...
def drug_information(
    ...
    """
    Search detailed medical descriptions of medicines or disease or active ingredient(generic_name), limit is the number of records needs.
    ...
    """
    if limit == None or limit > 10 or limit <= 0:
        limit = 3
